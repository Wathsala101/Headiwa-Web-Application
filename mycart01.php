...
$sql = "SELECT tblpurchases.BookingId as bookid,tblpurchases.ProductId as pkgid,tblmarket.ProductName as productname,tblpurchases.FromDate as fromdate,tblpurchases.ToDate as todate,tblpurchases.Comment as comment,tblpurchases.status as status,tblpurchases.RegDate as regdate,tblpurchases.CancelledBy as cancelby,tblpurchases.UpdationDate as upddate from tblpurchases join tblmarket on tblmarket.ProductId=tblpurchases.ProductId where UserEmail=:uemail";
$query = $dbh->prepare($sql);
