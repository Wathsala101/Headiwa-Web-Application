...
if (isset($_POST['submit2'])) {
    ...
    $status = 0;
    $sql = "INSERT INTO tblpurchases(ProductId,UserEmail,FromDate,ToDate,Comment,status) VALUES(:pid,:useremail,:fromdate,:todate,:comment,:status)";
